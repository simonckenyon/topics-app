...
import ie.koala.topics.feature.stocks.repository.paging.LoadingState
...
class RealtimeDatabaseQueryDataSource private constructor(private val baseQuery: Query)
    ...
    companion object {
        private val log = LoggerFactory.getLogger(RealtimeDatabaseQueryDataSource::class.java)
    }
        ...
        baseQuery
            ...
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    log.debug("loadInitial.onDataChanged: snapshot=$snapshot")
                ...
                override fun onCancelled(error: DatabaseError) {
                    ...
                    log.error("onCancelled: error loading paged items", error.toException())
                }
            })
    }
    ...
    override fun loadAfter(params: LoadParams<PageKey>, callback: LoadCallback<PageKey, DataSnapshot>) {
        ...
        baseQuery
            ...
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    log.debug("loadAfter.onDataChanged: snapshot=$snapshot")
                    mutableLoadingState.postValue(LoadingState.LOADED)
